...
<cfset Variables.frogged 			= ArrayNew(1)>
<cfset Variables.todolist 			= "inprogress,finishednophoto,hibernating">
<cfset Variables.counter 			= 1>

<!--- grab project data --->
<cfhttp url="http://api.ravelry.com/projects/caracolina/progress.json?key=ec9ae57dd9516720c35c3df8d8094940a20ee480&status=in-progress+hibernating+finished+frogged&notes=true">
...
<link href="http://style2.ravelrycache.com/stylesheets/ravelry_global_1207201616.css" rel="Stylesheet" type="text/css" />
<link href="http://style2.ravelrycache.com/stylesheets/ravelry_components_1207191659.css" rel="Stylesheet" type="text/css" />
</head>
...
<cfif ArrayLen(Variables.inprogress) or ArrayLen(Variables.finishednophoto) or ArrayLen(Variables.hibernating)>
	...
	<cfloop list="inprogress,finishednophoto,hibernating" index="todo">
		...
		<cfif ArrayLen(Variables.arrayTodo)>		
			...
			<h2 style="margin-top: 20px">#Variables.counter#. 
